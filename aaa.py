...
class aaa(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "workshop 4.3a", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("workshop 4.3a")
        ...
        self.bps = bps = 1
        self.symb_rate = symb_rate = 275*1000
        self.samp_rate_0 = samp_rate_0 = 1100*1000
        self.samp_rate = samp_rate = 32*1000
        self.num_taps = num_taps = 11*sps
        self.header_format = header_format = digital.header_format_default(preamble, threshold, bps)
        ...
        self.analog_const_source_x_0 = analog.sig_source_b(0, analog.GR_CONST_WAVE, 0, 0, preamble)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.digital_chunks_to_symbols_xx_0, 0))
        self.connect((self.analog_random_source_x_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_uchar_to_float_1, 0))
        ...
        self.connect((self.blocks_throttle_0, 0), (self.digital_correlate_access_code_xx_ts_0, 0))
    ...
    def set_threshold(self, threshold):
        ...
        self.set_header_format(digital.header_format_default(self.preamble, self.threshold, self.bps))
    ...
    def set_preamble(self, preamble):
        ...
        self.set_header_format(digital.header_format_default(self.preamble, self.threshold, self.bps))
        self.analog_const_source_x_0.set_offset(self.preamble)
